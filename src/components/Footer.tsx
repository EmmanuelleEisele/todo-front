...
const Footer: React.FC = () => {
  return (
    <footer className="footer p-2 text-center font-sans font-semibold ">
      <div className="container mx-auto">
        <Link to="/legal" className="text-orange-800 mb-1 inline-block no-underline">Mentions légales</Link>
        <Link to="/contact" className="text-orange-800 mb-1 inline-block no-underline pl-4">Nous contacter</Link>
