...
function App() {
  ...
  // Vérifie la validité du token au chargement, et à chaque changement de route vers /tasks ou /dashboard
  useEffect(() => {
    if (location.pathname !== "/tasks" && location.pathname !== "/dashboard") return;
